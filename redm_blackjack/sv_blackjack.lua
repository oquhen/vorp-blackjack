   ...
   local _source = source
    ...
    local money2 = money*2
		if condition == "lose" then
            ...
            TriggerClientEvent("ak_notification:Left", playerId, "Blackjack", "Dealer won you lost $" ..money.. "", 5000)
		elseif condition == "win" then
		--	VORP.addCurrency(playerId, 0, money*2)
            TriggerClientEvent("ak_notification:Left", playerId, "Blackjack", "You Won $" ..money2.. "", 5000)
            Character.addCurrency(0,  money2)
		elseif condition == "push" then
			--VORP.addCurrency(playerId, 0, money)
            TriggerClientEvent("ak_notification:Left", playerId, "Blackjack", "Push! Take your Money Back", 5000)
